...
/// <summary>
/// Controle WinForms que hospeda o viewer Quake II. Todo acesso ao GLFW/OpenGL
/// permanece na thread da UI, como exigido pelo OpenTK/GLFW.
/// </summary>
public sealed class Quake2MapControl : GLHostControl
{
    ...
    protected override void OnPaint(PaintEventArgs e)
    {
        ...
        game.Render(Math.Max(1, ClientSize.Width), Math.Max(1, ClientSize.Height));
        SwapBuffers();
    }
